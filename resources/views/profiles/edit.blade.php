            ...
            <div class="row">
                ...
                <div class="col-8">
                    ...
                    <div class="form-group">
                        ...
                        <p>Location: </p>
                        <textarea class="form-control" name="location" value="{{old('location')}}" id="location" rows="3">{{ $profile->location }}</textarea>            
                    </div>
                    
                    <div class="form-group">
                        <label class="sr-only" style="visibility:hidden" id="bio" ></label>
                        <p>Bio:</p>
                        <textarea class="form-control" name="bio" value="{{old('bio')}}" id="bio" rows="3">{{ $profile->bio }}</textarea>            
                    </div>
